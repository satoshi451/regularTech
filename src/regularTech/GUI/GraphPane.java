...
public class GraphPane extends JPanel{
    ...
    static{
        ...
        try {
            computer = ImageIO.read(ActionArea.class.getResource("/regularTech/img/computer.png"));
            printer = ImageIO.read(ActionArea.class.getResource("/regularTech/img/printer.png"));
            monitor = ImageIO.read(ActionArea.class.getResource("/regularTech/img/monitor.png"));
            router = ImageIO.read(ActionArea.class.getResource("/regularTech/img/router.png"));
        } catch(IOException e){
            e.printStackTrace();
        }
    }
